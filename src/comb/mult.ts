...
function mult(in1_count: number, in2_count: number, preffix_in1?: string, preffix_in2?: string) {
    return new Mult(in1_count, in2_count, preffix_in1, preffix_in2);
}
