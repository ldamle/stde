...
<head>
    <title>Code coverage report for src/controller/element.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/controller</a> element.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">21x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as Types from '../types';
...
&nbsp;
    ...
    constructor(
        ...
        this.state = <span class="fstat-no" title="function not covered" >() =</span>&gt; <span class="cstat-no" title="statement not covered" >'';</span>
        this.name = '';
        ...
        if (typeof arg1 === 'string') {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (arg2 instanceof Array &amp;&amp; arg3 instanceof Array &amp;&amp; typeof signals === 'function') {
<span class="cstat-no" title="statement not covered" >                this.setParams(arg2, arg3 as string[], signals);</span>
            }
        } else {
...
<span class="cstat-no" title="statement not covered" >                this.setParams(arg2, arg3 as string[], signals);</span>
        ...
        this.delay = Array(this.out_connections.length).fill(stde.delay.standart);
    }
&nbsp;
    /**
...
&nbsp;
    ...
    inIndex(name: string): number {
        for (let i = 0; i &lt; this.in_connections.length; i++) {
            if (typeof this.in_connections[i] === 'string') {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (this.in_connections[i] === name) {
...
&nbsp;
    ...
    inArray(): string[] {
        const arr: string[] = [];
        for (let i = 0; i &lt; this.in_connections.length; i++) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof this.in_connections[i] === 'string') {
                arr.push(this.in_connections[i] as string);
            } else {
<span class="cstat-no" title="statement not covered" >                arr.push((this.in_connections[i] as Types.Interface.Connection).findInString(this));</span>
            }
        }
        return arr;
    }
...
&nbsp;
<span class="fstat-no" title="function not covered" >    inStateArray(</span>): Types.signal.array {
        let sa = <span class="cstat-no" title="statement not covered" >'';</span>
<span class="cstat-no" title="statement not covered" >        if (this.props['tet']){</span>
<span class="cstat-no" title="statement not covered" >            for(let i = <span class="cstat-no" title="statement not covered" >this.props.tet.length-1;</span> i &gt;= 0; i++){</span>
<span class="cstat-no" title="statement not covered" >                if(this.props.tet[i].isIn){</span>
<span class="cstat-no" title="statement not covered" >                    return this.props.tet[i].state;</span>
                }
            }
        }
<span class="cstat-no" title="statement not covered" >        for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; this.in_connections.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >            if (typeof this.in_connections[i] === 'string') {</span>
<span class="cstat-no" title="statement not covered" >                sa += 'z'</span>
            } else {
<span class="cstat-no" title="statement not covered" >                sa += (this.in_connections[i] as Types.Interface.Connection).state as Types.signal.array;</span>
            }
        }
<span class="cstat-no" title="statement not covered" >        return sa;</span>
    }
}
&nbsp;
/**
...
&nbsp;
<span class="fstat-no" title="function not covered" >    inStateArray(</span>): Types.signal.array {
<span class="cstat-no" title="statement not covered" >        return this.out_connections[0].state as Types.signal.array;</span>
    }
}
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Oct 21 2024 20:26:11 GMT+0300 (Москва, стандартное время)
            </div>
        </div>
