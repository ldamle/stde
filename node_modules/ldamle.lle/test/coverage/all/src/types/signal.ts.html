...
<head>
    <title>Code coverage report for src/types/signal.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/types</a> signal.ts</h1>
        <div class='clearfix'>
...
function __getArrayIt(signal: it): array {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (signal === 0 || signal === 1) {
        return signal.toString();
    }
<span class="cstat-no" title="statement not covered" >    return signal;</span>
}
&nbsp;
/**
