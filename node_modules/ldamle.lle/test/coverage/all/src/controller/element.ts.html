...
<span class="cstat-no" title="statement not covered" >                this.setParams(arg2, arg3 as string[], signals);</span>
        ...
        this.delay = Array(this.out_connections.length).fill(stde.delay.standard);
    }
&nbsp;
    /**
...
<span class="fstat-no" title="function not covered" >    inStateArray(</span>): Types.signal.array {
        ...
        // if (this.props['tet']){
        //     for(let i = this.props.tet.length-1; i &gt;= 0; i--){
        //         if(this.props.tet[i].isIn &amp;&amp; !this.props.tet[i].state.includes('z')){
        //             return this.props.tet[i].state;
        //         }
        //     }
        // }
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Oct 22 2024 19:26:35 GMT+0300 (Москва, стандартное время)
            </div>
        </div>
