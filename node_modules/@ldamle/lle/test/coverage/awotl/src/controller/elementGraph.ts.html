...
<head>
    <title>Code coverage report for src/controller/elementGraph.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/controller</a> elementGraph.ts</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>133/134</span>
            </div>
...
&nbsp;
    ...
    getConnectionsNode(node: Types.elementGraph.node): Types.Interface.Connection[] {
        ...
        for (let i = 0; i &lt; node.element.out_connections.length; i++) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (node.element.out_connections[i].in) {
        ...
        for (let i = 0; i &lt; nodes.length; i++) {
            ...
            if (nodes[i].element.in_connections) {
                ...
                for (let j = 0; j &lt; thisConns.length; j++) {
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof thisConns[j] === 'string') {
<span class="cstat-no" title="statement not covered" >                        elements[i].connections_in.push({</span>
