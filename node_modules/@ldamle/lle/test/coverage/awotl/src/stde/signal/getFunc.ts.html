...
<head>
    <title>Code coverage report for src/stde/signal/getFunc.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/stde/signal</a> getFunc.ts</h1>
        <div class='clearfix'>
...
<a name='L170'></a><a href='#L170'>170</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">21x</span>
...
function getFuncElement(
    ...
    return getFunc(
        array,
        elem.in_connections ? elem.in_connections.length : <span class="branch-1 cbranch-no" title="branch not covered" >0,</span>
        elem.out_connections.length,
        elem.inArray ? elem.inArray() : <span class="branch-1 cbranch-no" title="branch not covered" >['']</span>
    );
}
&nbsp;
/**
...
function getFunc(
    ...
    return (a: Types.signal.array): Types.signal.array =&gt; {
        ...
        if (int) {
            return int;
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (gState.length &gt; 0) {
...
function genStateDetailSignal(state: Types.signal.detail, gState: Types.signal.array[]): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(state.in)) {
<span class="cstat-no" title="statement not covered" >        state.in = state.in.join('');</span>
    }
...
function genStateSignal(
    ...
    if (state.name === 'else') {
        const eqArray: Types.signal.array = 'z'.repeat(outLen);
        for (let i = 0; i &lt; gState.length; i++) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (JSON.stringify(gState[i]) === JSON.stringify(eqArray)) {
<span class="cstat-no" title="statement not covered" >                gState[i] = state.out as Types.signal.array;</span>
            }
        }
        return;
    }
