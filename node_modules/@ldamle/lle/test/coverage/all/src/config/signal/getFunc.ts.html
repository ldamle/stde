...
<head>
    <title>Code coverage report for src/config/signal/getFunc.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/config/signal</a> getFunc.ts</h1>
        <div class='clearfix'>
...
function getFunc(
    ...
    return (a: Types.signal.array): Types.signal.array =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (int) {
            return int;
        } else <span class="cstat-no" title="statement not covered" >if (gState.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >            return 'z'.repeat(gState[0].length);</span>
        } else {
