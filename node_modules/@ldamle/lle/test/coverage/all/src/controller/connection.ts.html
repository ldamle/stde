...
<head>
    <title>Code coverage report for src/controller/connection.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/controller</a> connection.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    ...
    constructor(
        ...
        this.out = outSource;
        this.state = 'z';
        this.style = config.style.connection.copy(config.style.connection.Default);
        if (arg2) {
            this.state = 'x';
...
&nbsp;
    ...
    disConnect(inSource: Types.source.it): Connection {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(this.in)) {
            for (let i = 0; i &lt; this.in.length; i++) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (this.in[i].name === inSource.name &amp;&amp; this.in[i].element === inSource.element) {
                    this.in.splice(i, 1);
                    break;
                }
            }
...
&nbsp;
     ...
     * @returns вход
     */
<span class="fstat-no" title="function not covered" >    findInSource(</span>element: Types.Interface.Element): Types.source.it {
<span class="cstat-no" title="statement not covered" >        if (Array.isArray(this.in)) {</span>
<span class="cstat-no" title="statement not covered" >            for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; this.in.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                if (this.in[i].element === element) {</span>
<span class="cstat-no" title="statement not covered" >                    return this.in[i];</span>
                }
            }
        }
