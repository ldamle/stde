...
<a name='L560'></a><a href='#L560'>560</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    constructor(
        ...
        this.name = '';
        this.style = config.style.element.copy(config.style.element.Default);
        if (typeof arg1 === 'string') {
            ...
            if (arg2 instanceof Array &amp;&amp; arg3 instanceof Array &amp;&amp; signals instanceof Array) {
                this.setParams(
                    arg2,
                    arg3 as string[],
                    config.signal.getFunc(signals, arg2.length, arg3.length, this.inArray())
                );
            }
...
<span class="cstat-no" title="statement not covered" >                this.setParams(arg2, arg3 as string[], signals);</span>
            ...
            if (arg1 instanceof Array &amp;&amp; arg2 instanceof Array &amp;&amp; arg3 instanceof Array) {
                this.setParams(
                    arg1,
                    arg2,
                    config.signal.getFunc(arg3, arg1.length, arg2.length, this.inArray())
                );
            }
            <span class="missing-if-branch" title="if path not taken" >I</span>if (arg2 instanceof Array &amp;&amp; arg3 instanceof Array &amp;&amp; typeof signals === 'function') {
<span class="cstat-no" title="statement not covered" >                this.setParams(arg2, arg3 as string[], signals);</span>
        ...
        this.delay = Array(this.out_connections.length).fill(config.delay.standard);
    }
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >                sa += (this.in_connections[i] as Types.Interface.Connection)</span>
                    .state as Types.signal.array;
            }
        }
...
&nbsp;
    ...
    constructor(arg1: number | string, frequency?: number) {
        this.props = {};
        this.delay = [];
        this.style = config.style.element.copy(config.style.element.Generator);
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Fri Oct 25 2024 19:21:53 GMT+0300 (Москва, стандартное время)
            </div>
        </div>
